			...
			<div class = "col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="widget-content">
                  <div class="padd" style="height:650px">
                    ...
                    <h3 style="text-align:center">YummyPartyPalace</h3>
<h4 style="text-align:center">Chisapani,Kathamndu</h4>
<h4 style="text-align:center">Phone No. : 9851081730</h4>
<h4 style="text-align:center">Gmail :  yummypartypalace@gmail.com</h4>
<h4 style="text-align:center">Facebook : facebook.com/Yummy Party Palce</h4>
<hr>
