...
<div class="navbar navbar-fixed-top bs-docs-nav" role="banner">
    ...
    <div class="conjtainer">
      ...
      <a href="index.html" class="navbar-brand hidden-lg">Yummy Party</a> Palace
    </div>
...
<div class="span10">
  <div class="contentheader">
      <ul class="breadcrumb">
      <font style=" font:bold 44px 'Aleo'; text-shadow:10px 10px 50px #000; color:black;"><center>Yummy Party Palace</center></font>
<div id="mainmain">
